...
function DiscordLib:Window(text)
	...
	UserPanelUserIcon.MouseButton1Click:Connect(function()
		...
		ChangeBtn.BackgroundColor3 = Color3.fromRGB(196, 40, 28)
		...
		ChangeBtn.MouseLeave:Connect(function()
			TweenService:Create(
				ChangeBtn,
				TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
				{BackgroundColor3 = Color3.fromRGB(196, 40, 28)}
			):Play()
		end)
		...
		CloseBtn1.BackgroundColor3 = Color3.fromRGB(196, 40, 28)
		...
		ResetBtn.BackgroundColor3 = Color3.fromRGB(196, 40, 28)
	...
	function DiscordLib:Notification(titletext, desctext, btntext)
		...
		AlrightBtn.BackgroundColor3 = Color3.fromRGB(196, 40, 28)
	...
	function ServerHold:Server(text, img)
		...
		ServerIco.Image = "rbxassetid://12602993431"
		...
		function ChannelHold:Channel(text)
			...
			function ChannelContent:Toggle(text,default,callback)
				...
				Icon.Image = "http://www.roblox.com/asset/?id=10653373712"
				...
				Toggle.MouseButton1Click:Connect(function()
					if toggled == false then
						TweenService:Create(
							Icon,
							TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
							{ImageColor3 = Color3.fromRGB(196, 40, 28)}
						):Play()
						TweenService:Create(
							ToggleFrame,
							TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
			...
			function ChannelContent:Slider(text, min, max, start, callback)
				...
				Slider.BackgroundColor3 = Color3.fromRGB(196, 40, 28)
				...
				Slider.Text = ""
				Slider.TextColor3 = Color3.fromRGB(196, 40, 28)
				Slider.TextSize = 14.000

				SliderTitle.Name = "SliderTitle"
				SliderTitle.Parent = Slider
				SliderTitle.BackgroundColor3 = Color3.fromRGB(196, 40, 28)
				SliderTitle.BackgroundTransparency = 1.000
				SliderTitle.Position = UDim2.new(0, 5, 0, -4)
				SliderTitle.Size = UDim2.new(0, 200, 0, 27)
				SliderTitle.Font = Enum.Font.Gotham
				SliderTitle.Text = text
				SliderTitle.TextColor3 = Color3.fromRGB(196, 40, 28)
				...
				SliderFrame.BackgroundColor3 = Color3.fromRGB(196, 40, 28)
				...
				CurrentValueFrame.BackgroundColor3 = Color3.fromRGB(196, 40, 28)
